...
void inserirInicio(int numero)
{
    ...
    if(!inicio)
    {
        ...
        fim=novo;
        inicio->anterior=fim;
        fim->proximo=inicio;//sempre é nulo
    }
    else
    {
...
void exibirEspecifico(int lembrarposicao,Lista *aux)
{
    ...
    printf("1 - Próximo | 2 - Anterior | 3 - Voltar\n: ");
    do
        scanf("%d",&continuar);
        ...
        switch(opcao)
        {
            case 1:
                ...
                if(tamanho==0)
                    ...
                    {
                        printf("1 - Inicio | 2 - Fim | 3 - Informar posicao\n: ");
